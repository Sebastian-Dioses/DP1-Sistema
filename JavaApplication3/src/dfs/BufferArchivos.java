...
public class BufferArchivos {
    ...
    public void generarJson(){
        ...
        try (FileWriter writer = new FileWriter("pedidosArutear"+ parte++ +".json")) {
        ...
        while((siguienteCiudad=gestor.siguienteEnvio()) != null){
            ...
            if(!primero && !temporalFecha[0].equals(ultimaFecha[0]))
            {
                ...
                if(contadorDia==6)
                {
                    contadorDia=0;
                    this.generarJson();
                    listaPedidosEscala1.clear();
                    listaPedidosEscala2.clear();
                    numeroPedidosEscala1=0;
                    numeroPedidosEscala2=0;
                    /*listaPedidosEscala1.values().stream().forEach((temporal) -> {
                        for(String temporal1:temporal) temporal1="";
                    });
                    numeroPedidosEscala1=0;
                    
                    listaPedidosEscala2.values().stream().forEach((temporal) -> {
                        for(String temporal1:temporal) temporal1="";
                    });
                    numeroPedidosEscala2=0;*/
