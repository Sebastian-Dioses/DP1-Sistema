...
// @LINE:8
private[this] lazy val controllers_Application_users3 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users"))))
...
// @LINE:8
case controllers_Application_users3(params) => {
   call { 
