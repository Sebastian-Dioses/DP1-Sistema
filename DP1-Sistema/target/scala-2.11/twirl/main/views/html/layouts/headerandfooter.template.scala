      ...
      <div class="collapse navbar-collapse" id="navbar1">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href='"""),_display_(/*138.29*/routes/*138.35*/.SessionC.account()),format.raw/*138.54*/("""' title="Ir a cuenta" target="_self">Mi Cuenta</a></li>
              <li><a href='"""),_display_(/*139.29*/routes/*139.35*/.SessionC.changePassword()),format.raw/*139.61*/("""' title="Cambiar contraseña" target="_self">Cambiar mi contraseña</a></li>
              <li><a href='"""),_display_(/*140.29*/routes/*140.35*/.SessionC.logout()),format.raw/*140.53*/("""' title="LOGOUT" target="_self">Logout</a></li>
            </ul>
          </li>
        </ul>
      </div><!-- /.navbar-collapse -->
